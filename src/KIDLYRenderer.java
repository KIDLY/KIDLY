 ...
 * <br><br>
 * <img src="../../../../../images/KIDLYRendererSample.png"
 * alt="KIDLYRendererSample.png" />
 */
public class KIDLYRenderer extends AbstractCategoryItemRenderer
    ...
    public static BarPainter getDefaultBarPainter() {
        return KIDLYRenderer.defaultBarPainter;
    }
    ...
    public static void setDefaultBarPainter(BarPainter painter) {
        ...
        KIDLYRenderer.defaultBarPainter = painter;
    }
    ...
    public static boolean getDefaultShadowsVisible() {
        return KIDLYRenderer.defaultShadowsVisible;
    }
    ...
    public static void setDefaultShadowsVisible(boolean visible) {
        KIDLYRenderer.defaultShadowsVisible = visible;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof KIDLYRenderer)) {
            return false;
        }
        KIDLYRenderer that = (KIDLYRenderer) obj;
